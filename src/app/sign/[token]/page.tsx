  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-zinc-50">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        <p className="text-sm text-zinc-400">You've been invited to confirm the splits for</p>
        ...
        {/* Your row */}
        <div className="mt-6 rounded-2xl border border-zinc-900/10 bg-white p-5">
          <p className="text-xs uppercase tracking-wide text-zinc-400">Your details</p>
          <p className="mt-1 text-lg font-semibold text-zinc-900">{collaborator.name}</p>
        ...
        {/* Full split table */}
        <div className="mt-6">
          <h2 className="mb-3 font-semibold text-zinc-900">The full split</h2>
          <SplitTable
        ...
        {legalTemplate && (
          <details className="mt-6 rounded-2xl border border-zinc-200 bg-white p-5">
            ...
            <pre className="mt-3 max-h-72 overflow-auto whitespace-pre-wrap rounded-xl bg-zinc-50 p-3 text-xs leading-relaxed text-zinc-600">
              {legalTemplate.body}
            </pre>
          </details>
        )}
